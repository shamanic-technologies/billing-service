...
- **Two cohorts today.** Accounts predating 0032 carry **$25 / $25** (`GRANDFATHERED_FREE_CREDIT_*`); accounts created after it carry **$400 / $400** (`CURRENT_FREE_CREDIT_*`). Verified on a prod fork: **93/93** existing accounts landed at 2500/2500, the column default reads 40000, promo rows (112) and the $1093 gifted total were untouched, and a fresh `INSERT … (org_id)` came back 40000/40000.
